...
class CowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cow" do
    assert_difference("Cow.count") do
      post cows_url, params: { cow: { age: @cow.age, farmer_id: @cow.farmer_id, name: @cow.name } }
    end
  ...
  test "should update cow" do
    patch cow_url(@cow), params: { cow: { age: @cow.age, farmer_id: @cow.farmer_id, name: @cow.name } }
